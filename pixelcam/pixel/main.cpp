...
int divisions = 80;	// Initial number of divisions
...
int main()
{
    ...
    cvNamedWindow("Low Rez Stream", CV_WINDOW_NORMAL);
...
*/
    ...
    IplImage* pLowRezFrame = cvCreateImage(cvSize(640, 360), IPL_DEPTH_8U, 3);
